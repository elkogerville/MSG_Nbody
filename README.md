...
## MSG_Nbody
### N-body simulation code leveraging Numba using the particle-particle algorithm for studying galaxy mergers with particles on the order of ~100,000-200,000
