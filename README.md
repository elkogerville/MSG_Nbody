...
## MSG_Nbody
### N-body simulation code leveraging Numba using the particle-particle algorithm for studying galaxy mergers with particles on the order of ~3x10<sup>4</sup>
...
<div align="center">
Left: Log plot of the energy distribution of spherical galaxy during a 10:1 merger using the <a href="https://github.com/elkogerville/MSG_Nbody/blob/main/MSG_Nbody/analysis.py#L473">plot_Ne</a> function.
</div>
<div align="center">
